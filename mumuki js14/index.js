// Necesitamos un programa que pida ingresar 3 destinos de las escalas de un vuelo, 
...
// Con esta información, el programa deberá mostrar todas las escalas con su
//  duración y la duración total del vuelo con el siguiente mensaje: La duración 
//  total del vuelo con escala en {escalaUno} de duración {duracionEscalaUno} hs, 
//  {escalaDos} de duración {duracionEscalaDos} hs y {escalaTres} de duración {duracionEscalaTres} 
//  hs es: {resultado} hs.
